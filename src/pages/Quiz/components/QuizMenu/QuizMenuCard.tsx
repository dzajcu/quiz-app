...
const QuizMenuCard = ({ title, description }: QuizMenuCardProps) => {
    return (
        <Card className="relative w-72 max-w-xs h-36 flex flex-col justify-between bg-primary overflow-hidden border-none">
